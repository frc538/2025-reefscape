...
public class Limelight extends SubsystemBase {
    ...
    private LimelightIOInputs[] mLimelightIOInputs = new LimelightIOInputs[2];

    public Limelight(Drive driveFile, LimelightIO[] Limelights) {  //I don't know if this was needed or not
        this.driveFile = driveFile;
        mLimelightIOs = Limelights;
        mLimelightIOInputs[0] = new LimelightIOInputs();
        mLimelightIOInputs[1] = new LimelightIOInputs();
    }
    ...
    public void periodic() {
        mLimelightIOs[0].updateInputs(mLimelightIOInputs[0]);
        mLimelightIOs[1].updateInputs(mLimelightIOInputs[1]);
