...
public class LimelightIOImplementation implements LimelightIO {
  ...
  public void updateInputs(LimelightIOInputs inputs, double yawAngleDegrees) {
    ...
    LimelightHelpers.PoseEstimate mt1 = LimelightHelpers.getBotPoseEstimate_wpiBlue(mLimelightName);
    LimelightHelpers.SetRobotOrientation(mLimelightName, yawAngleDegrees, 0, 0, 0, 0, 0);
    LimelightHelpers.PoseEstimate mt2 =
        LimelightHelpers.getBotPoseEstimate_wpiBlue_MegaTag2(mLimelightName);
    if (mt1 != null) {
