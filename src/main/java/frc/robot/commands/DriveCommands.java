...
public class DriveCommands {
  ...
  public static void elevatorDrivetrainGain(double percentHeight) {
    selectedElevatorSpeedGain = MathUtil.interpolate(elevatorSpeedGainDown, elevatorSpeedGainUp, percentHeight);
  }
  ...
  public static Command joystickDrive(
    ...
    return Commands.run(
        () -> {
          ...
          ChassisSpeeds chassisRelativeSpeeds = ChassisSpeeds.fromFieldRelativeSpeeds(
              speeds,
              isFlipped
                  ? drive.getRotation().plus(new Rotation2d(Math.PI))
                  : drive.getRotation());

          chassisRelativeSpeeds.vxMetersPerSecond = chassisRelativeSpeeds.vxMetersPerSecond * selectedElevatorSpeedGain;
